...
public class Stats
{
    ...
    //Events
    public static event UnityAction<int> onHealthBarChange;
    ...
    public int Health { get { return health; } set { health = Mathf.Max(0, value); if (onHealthBarChange != null) { onHealthBarChange(health); } } }
    public int HealthLeft { get { return healthLeft; } set { healthLeft = Mathf.Clamp(value, 0, health); CalculateStatsOutput(); if (onHealthChange != null) { onHealthChange(healthLeft); } } }
    ...
    public int MPLeft {
        get => mpLeft; set {
            mpLeft = Mathf.Clamp(value, 0, mp); if (updateMP != null) updateMP(MPLeft);
        }
    }
